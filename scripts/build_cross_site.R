...
# mean ubiquity, and the Culex share of the catch. Culex is descriptive taxonomic
# context here; this catch product carries no pathogen test or health-risk result.
#
...
attr(cs, "method") <- sprintf("Richness rarefied to %d collection occasions (incidence rarefaction; Colwell et al. 2012). Hill q1/q2 on incidence; coverage = Chao & Jost 2012. Culex share is descriptive taxonomic context from the whole-trap catch; no pathogen or health-risk inference.", t_common)
